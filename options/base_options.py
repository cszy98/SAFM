...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--segepoch', type=int, default=50, help='input batch size')
        ...
        parser.add_argument('--instance_root', type=str, default='')
        ...
        # for generator
        parser.add_argument('--netG', type=str, default='safm', help='selects model to use for netG (pix2pixhd | spade)')
    ...
    def parse(self, save=False):
        ...
        opt.semantic_nc = opt.label_nc + \
            ...
            (0 if opt.no_instance else 1) + 72
